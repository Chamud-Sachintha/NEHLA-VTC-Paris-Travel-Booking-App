...
return [
    ...
    */
    ...
    //main slider
    // first
    'f_subtitle'=>'Véhicules de Transport Haut De Gamme Sur Paris, Aeroports, Gares Et Excursions',
    'f_title'=>'Profitez d\'une expérience Unique',

    //second
    's_subtitle'=>'Un Trajet unique pour se détendre et profiter',
    's_title'=>'Le Trajet Parfait pour vous',
    ...
    //2 section
    'sec_2_subtitle'=>'Un voyage avec NEHLA VTC PARIS',
    'sec_2_title'=>'Profitez d’une expérience unique',
    'sec_2_desc_1'=>'NEHLA VTC PARIS vous offre confort et sécurité. Nos chauffeurs sont à votre disposition afin de vous assurer des trajets de qualité à Paris, Île-de-France, France et Europe.',
    'sec_2_desc_2'=>'Nos chauffeurs disposent uniquement de voitures Mercedes Benz Classe S Série et Classe V Série vous garantissant ainsi le meilleur du confort, de la sécurité et de la discrétion. Vous pourrez poser vos questions à tout moment en anglais ou en français au chauffeur qui vous accompagne. Tous ces éléments sont réunis dans le seul objectif : vous faire vivre un trajet des plus agréables.',
    
    'sec_2_desc_3'=>'Idéale pour les voyages d’affaires, NEHLA VTC est également disposée à accompagner les touristes dans la découverte de la capitale de l’amour et de la mode. ',
    // 'sec_2_desc_4'=>'Idéal pour les voyages d\'affaires et personnels.',
    'sec_2_desc_4'=>'En début et fin de voyage, nos chauffeurs assurent les transferts depuis et jusqu’aux aéroports/gares. Vous pouvez, par ailleurs, réserver des trajets à des fins professionnelles (rendez-vous d’affaires) ainsi qu’à des fins personnelles (visites, découvertes, loisirs).',
    'normal_tours'=>'Nos trajets en Île de France',
    'fill_in_the_form'=>'Réserver en ligne',
    'special_tours'=>'Nos excursions sur devis',
    'see_our_plans'=>'Voir nos excursions',

    //3rd section reservation form
    'sec_3_title'=>'Réservez votre trajet sur Paris et Île de France',
    'your_jurney'=>'Votre trajet',
    'quotation'=>'Véhicule',
    ...
    'return_from'=>'Formulaire de retour',
    'return_to'=>'retourner à',
    'flight_number'=>'Numéro de vol / de train',
    ...
    'promo_code_txt'=>'Ajouter un code promotionnel',
    'add_promo_btn'=>'Ajouter une promotion',
    'promotional_details'=>'Détails promotionnels',
    'name'=>'modèle',
    'reg_details'=>'Détails d\'inscription',
    'new_cli'=>'Nouvelle cliente',
    'existing_cli'=>'Client existant',
    'fname'=>'Prénom',
    'lname'=>'Nom de famille',
    'mobile'=>'Numéro de portable',
    'email'=>'Email',
    'create_pswd'=>'Créer un mot de passe',
    ...
    // 4th section
    'sec_4_sub_title'=>'NEHLA VTC PARIS',
    'sec_4_title'=>'Nos véhicules',
    'car_1_title'=>'Mercedes Classe S Série',
    'car_1_desc_1'=>'La Mercedes Classe S Série est idéale pour les petits comités jusqu’à 3 passagers. Ce modèle allie habilement luxe et technologie, apportant le confort et la sécurité nécessaires à nos chauffeurs pour vous prendre en charge. De plus, nous vous garantissons un cadre optimal de travail ou de détente. Le design épuré de la Mercedes Classe S Série se concentre sur l’essentiel : l’intérieur assemble esthétisme et confort pour apporter un climat de bien-être exceptionnel.',
    'car_1_desc_2'=>'Votre voyage nécessite une voiture moderne, choisissez le design épuré de la Classe S qui se concentre sur l\'essentiel : des proportions parfaites à l\'extérieur et un luxe moderne à l\'intérieur. Les innovations de la Classe S démontrent ainsi une présence unique à laquelle on ne peut échapper.',
    'car_2_title'=>'Mercedes Classe V Série',
    'car_2_desc_1'=>'Pour vos trajets en groupe ou même seul pour votre plus grand confort et discrétion, la Classe V vous séduira par son confort supérieur digne de Mercedes-Benz : de l\'habitabilité exceptionnelle à la qualité incomparable de ses matériaux et finitions, en passant par son concept de fonctionnement intuitif et éclairage d\'ambiance. Tout a été fait pour rendre votre séjour en Classe V le plus agréable possible.',
    'car_2_desc_2'=>'La Classe V est un véritable accroche-regard. A l\'extérieur, son design est incomparable. Le charme agit dès le premier coup d\'œil à l\'intérieur : l\'habitacle est moderne et le choix de matériaux nobles aux finitions soignées le rend aussi agréable à regarder qu\'à toucher.',

    // 5th section
    'sec_5_sub_title'=>'NOS SERVICES',
    'sec_5_title'=>'A bord de nos véhicules',
    'card_1_title'=>'Rafraîchissements, boissons',
    ...
    'tr_1'=>'Excursion en Normandie',
    'tr_1_desc'=>'La Normandie compte plusieurs lieux et traditions classés ou inscrits au patrimoine mondial de l\'UNESCO, mais aussi des villages classés parmi les "Plus beaux villages de France" et des stations thermales. Au-delà de ces sites remarquables, et de nombreux détours magnifiques, chaque ville et village de Normandie est à découvrir !',
    'exp'=>'EXPÉRIENCES',
    'tr_2'=>'Le tour de l’Europe',
    'tr_2_desc'=>'Envisagez-vous de vous lancer dans l\'une des aventures les plus exotiques à travers un tour d\'Europe ? Qu\'il s\'agisse d\'un projet réfléchi ou d\'une envie soudaine, vous souhaitez partir à l\'aventure sur les routes européennes ?.',
    'modern'=>'Découverte',
    'tr_3'=>'Visite de Paris',
    'tr_3_desc'=>'Vivez une belle visite de Paris. Un tour de Paris en van ou en voiture est le tour idéal pour une première visite à Paris. Vous vivrez un moment extraordinaire lors d\'un tour de ville en voiture. Des vues panoramiques vous permettront de découvrir les sites parisiens incontournables, comme l\'Opéra Garnier, la Tour Eiffel, ou les Champs Elysées. Tout au long de cette visite...',
    'learn_more'=>'En savoir plus',

    //footer
    'about_title'=>'À propos de NEHLA VTC Paris',
